            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {filteredTemplates.map(tpl => (
                ...
                >
                  {/* 卡片头部 */}
                  <div
                    className="p-4 border-b border-slate-100 flex items-start justify-between"
                  ...
                  <div className="p-3.5 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
                    <span className="text-[11px] text-slate-500 font-medium">
                      预设周期: {tpl.presetPeriod === 'week' ? '周报' : tpl.presetPeriod === 'month' ? '月报' : '自定义'}
                    </span>
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="px-3.5 py-1.5 text-xs font-semibold text-white bg-blue-600 hover:bg-blue-700 rounded-lg shadow-2xs flex items-center gap-1.5 transition-colors cursor-pointer"
                      >
